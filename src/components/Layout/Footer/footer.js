...
const Footer = () => {
  return (
    <div className="w-full bg-Purple-900 relative footer-border">
      <div className="max-w-[1440px] mx-auto flex flex-col px-[20px] pt-[41px] ">
      ...
      <div className="max-w-[1440px] pr-[38px] pl-[20px] lg:pl-[165px] mx-auto pt-4 pb-[14px]">
        <span className="p-xlarge !font-medium text-Grey-500  ">
